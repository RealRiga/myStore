...
function NewArrivalProduct() {
  ...
  return (
    <div className="min-h-screen">
      <Header />
      {value && (
        <div className="bg-white mt-14 lg:px-16 md:px-8 sm:px-4 w-screen">
          <div className="flex flex-col-reverse md:flex-row max-w-screen">
            <div className="space-y-5 flex-1 px-10">
              ...
              <div className="flex justify-between items-center">
                <span className="text-xs font-regular text-black font-bold">
                  ${value.price}
                </span>
              </div>
